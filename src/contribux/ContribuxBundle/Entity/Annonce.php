 ...
 * @ORM\Entity(repositoryClass="contribux\ContribuxBundle\Repository\AnnonceRepository")
 */
class Annonce
{
    /**
    ...
    private $serviceOT;
     ...
     /**
     * @ORM\ManyToOne(targetEntity="contribux\ContribuxBundle\Entity\Categorie",cascade={"persist"}, inversedBy="annonces")
     *
     */
    private $categorie;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="contribux\UserBundle\Entity\User", inversedBy="annonces")
     *
     */
    private $user;
     ...
     * Set categorie
     *
     * @param \contribux\contribuxBundle\Entity\Categorie $categorie
     *
     * @return Annonce
     */
    public function setCategorie(\contribux\contribuxBundle\Entity\Categorie $categorie)
    {
     ...
     * Get categorie
     *
     * @return \contribux\contribuxBundle\Entity\Categorie
     */
     ...
     * Set user
     *
     * @param \contribux\UserBundle\Entity\User $user
     *
     * @return Annonce
     */
     ...
     * Get user
     *
     * @return \contribux\UserBundle\Entity\User
     */
